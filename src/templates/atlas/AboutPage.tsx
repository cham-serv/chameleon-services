    ...
    <section style={{ padding: '4rem 1.5rem' }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--brand-text, #555)', marginTop: '1rem', lineHeight: 1.7 }}>
          Atlas AboutPage stub — <strong>{variant}</strong> variant.
          Phase 4: team grid, story narrative, or timeline layout.
        </p>
        <Suspense fallback={null}>
          <div style={{
            ...
            {variant === 'team-grid' ? 'Team Grid Placeholder' : 'Story Split Placeholder'}
          </div>
        </Suspense>
      </div>
    </section>
