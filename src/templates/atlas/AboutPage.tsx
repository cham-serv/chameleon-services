/**
 * Atlas AboutPage â€” Server Component
 *
 ...
 *
 * Variants:
 *   team-grid   â€” Professional: hero + mission + values grid + team photo grid + CTA
 *   story-split â€” Narrative: full-width hero + zigzag text/image + founder note + scroll team + CTA
 *   manifesto   â€” Typography-driven: full-viewport statement + pull-quote values + minimal team list + CTA
 */
...
export default function AboutPage({ config, variant }: PageProps) {
  ...
  // â”€â”€ Variant-specific content resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const defaultHeadline = `About ${siteName}`;
  const defaultIntro = tagline || `${siteName} â€” built on the belief that every business deserves a powerful digital presence.`;
...
// â”€â”€ Variant: team-grid â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function renderTeamGrid({ siteName, headline, intro, heroImageUrl, teamMembers, breadcrumbs }: TeamGridProps) {
  return (
    <div className="atlas-about--team-grid" data-variant="team-grid">
      ...
      {/* â”€â”€ Mission Section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
...
// â”€â”€ Variant: story-split â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function renderStorySplit({ siteName, headline, intro, heroImageUrl, teamMembers, breadcrumbs }: StorySplitProps) {
  ...
  return (
    <div className="atlas-about--story-split" data-variant="story-split">
      ...
      {/* â”€â”€ Hero â€” full-width with gradient overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ Journey â€” zigzag rows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="atlas-container atlas-section">
      ...
      {/* â”€â”€ Founder's Note â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      {founderMember && (
        <section
          style={{
        ...
        >
          <div className="atlas-container">
            <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
              ...
              >
                {intro || `We started ${siteName} because we believed there was a better way â€” one that puts people first, quality above all, and builds lasting value rather than chasing short-term wins.`}
              </p>
      ...
      {/* â”€â”€ Team â€” horizontal scroll strip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
...
// â”€â”€ Variant: manifesto â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function renderManifesto({ siteName, headline, subheadline, teamMembers }: ManifestoProps) {
  return (
    <div className="atlas-about--manifesto" data-variant="manifesto">
      ...
      {/* â”€â”€ Full-viewport opening statement â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section
        style={{
          minHeight: '100svh',
          display: 'flex',
      ...
      {/* â”€â”€ Beliefs as pull-quotes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section>
      ...
      {/* â”€â”€ Minimal team list â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ Bold closing CTA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section
        style={{
