...
export default function AtlasFooter({ config }: Props) {
    ...
    <footer className="atlas-footer">
      <div className="atlas-container">
        <div className="atlas-footer-grid">
          ...
          <div>
            ...
            {contactEmail && (
              <a
                ...
                style={{ display: 'block', marginTop: '1rem', fontSize: '0.875rem' }}
              >
                {contactEmail}
              </a>
            )}
          ...
          {navLinks.length > 0 && (
            <div>
              <div className="atlas-footer-heading">Quick Links</div>
              <ul className="atlas-footer-links">
                {navLinks.map((link) => (
                  <li key={link.href}>
          ...
          {/* Column 3: Contact */}
          <div>
            <div className="atlas-footer-heading">Contact</div>
            <ul className="atlas-footer-links">
              {contactEmail && (
                <li>
...
// Simple inline SVG icons for common social platforms
