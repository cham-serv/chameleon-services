    ...
    <section style={{ padding: '4rem 1.5rem' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--brand-text, #555)', marginTop: '1rem', lineHeight: 1.7 }}>
          Atlas ResourcesPage stub — <strong>{variant}</strong> variant.
          Phase 4: resource grid or magazine layout with search and filtering.
        </p>
        <Suspense fallback={null}>
          <div style={{
            ...
            {variant === 'grid' ? 'Resource Grid' : 'Magazine Layout'} Placeholder
          </div>
        </Suspense>
      </div>
    </section>
